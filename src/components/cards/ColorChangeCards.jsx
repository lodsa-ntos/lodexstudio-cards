    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 w-full max-w-6xl mx-auto">
      ...
      <article className="w-full h-64">
        ...
        >
          <figure className="absolute inset-0">
            <img
              src="https://images.unsplash.com/photo-1755004609166-f20e6ecd22c4?q=80&w=1073&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Vibrant abstract color gradient background"
              loading="lazy"
              className="w-full h-full object-cover transition-transform duration-500 ease-out filter grayscale group-hover:grayscale-0 motion-safe:group-hover:scale-110 "
            />
      ...
      <article className="w-full h-64">
        ...
        >
          <figure className="absolute inset-0">
            <img
              src="https://images.unsplash.com/photo-1728942756635-0407678db122?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Vibrant abstract color gradient background"
              loading="lazy"
              className="w-full h-full object-cover transition-transform duration-500 ease-out filter grayscale group-hover:grayscale-0 motion-safe:group-hover:scale-110 "
            />
      ...
      <article className="w-full h-64">
        ...
        >
          <figure className="absolute inset-0">
            <img
              src="https://plus.unsplash.com/premium_photo-1719862007265-34e67f3943b3?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Vibrant abstract color gradient background"
              loading="lazy"
              className="w-full h-full object-cover transition-transform duration-500 ease-out filter grayscale group-hover:grayscale-0 motion-safe:group-hover:scale-110 "
            />
